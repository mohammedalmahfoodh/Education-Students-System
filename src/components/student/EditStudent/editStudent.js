...
class EditStudent extends Component {
    ...
    componentDidMount() {
        ...
        let ssn = this.props.match.params.student_ssn;
        axios.get("http://localhost:8080/student/getBySocialSecurity?socialSecurity="+ssn)
            .then((respons) => {
    ...
    render() {
        const studentTemplate=this.state.name!=='' ?( <div id="AddNewStudentContainer" className="row container center">
